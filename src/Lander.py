...
class Lander:
    def __init__(self, dir, startPoint = Pointf(0, 0)):
        # These need to be hand defined in  the lander child class
        self._mass =         None
        self.legStrength =   None
        self.mainThrust =    None
        self.rightThrust =   None
        self.leftThrust =    None
        self.fuelUsage =     None
    ...
    def update(self, gravity, groundPoints, surface, offset = Pointf(0, 0)):
        if not self.exploded:
            ...
            if RlegInContact or LlegInContact:
                ...
                if self.momentum['vert'] > self.legStrength or self.momentum['horz'] > self.legStrength * 1.5:
            ...
            if self.fuel:
                if self.thrusters['bottom']:
                    ...
                    self.fuel -= self.mainThrust * self.fuelUsage
                ...
                if self.thrusters['left']:
                    ...
                    self.fuel -= self.rightThrust * self.fuelUsage
                ...
                if self.thrusters['right']:
                    ...
                    self.fuel -= self.leftThrust * self.fuelUsage
